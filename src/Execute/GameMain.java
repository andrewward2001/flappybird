...
public class GameMain extends JPanel {
    ...
    public GameMain(){
        ...
        runtime = new Timer(40, e -> {
            ...
            functions.score(pipeSets, bird);

            if(keys[KeyEvent.VK_ESCAPE] && active)
                active = false;
             else if(keys[KeyEvent.VK_ESCAPE] && !active)
                active = true;
    ...
    public void paintComponent(Graphics g){
        ...
        g2.drawString("Score: " + Integer.toString(score), 0, 40);
